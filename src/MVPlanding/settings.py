...
SECRET_KEY = '35^encvl+&++x)$2w*!d9r33x8l@dj&3r7!c^3hsv*obz&5^9t'
...
EMAIL_HOST_USER = 'jhondoe@gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
WSGI_APPLICATION = 'MVPlanding.wsgi.application'
